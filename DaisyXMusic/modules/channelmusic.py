...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/fd431ba1c401fe7116fb2.jpg"
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        user.first_name = "INDIAN NETWORKS MUSIC"
    usar = user
    wew = usar.id
    try:
        # chatdetails = await USER.get_chat(chid)
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @INDIANVCPLAYER to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/fd431ba1c401fe7116fb2.jpg"
